...
// try{//try catach examples
//     const data = '{"name" : "josh", "age":30, "car":null}';
//     console.log(JSON.parse(data));//to convert our json string back to a js object
// }catch(error){
...
// for(let i = 0; i < 10; i++){
//     try{
//         if(i === 5) throw new Error("variable i is 5");
//         console.log(i);
//     }
//     catch(error){
...
///in a file storage.js make a service for local storage
...
//create a functions.js file that will hold the todo list methods
//in this file only implement the todolist event listeners
